...
[![LICENSE](https://img.shields.io/github/license/enfein/mieru.svg?style=flat)](https://github.com/QubitPi/mieru/blob/master/LICENSE)
...
For an explanation of the mieru protocol, see [mieru Proxy Protocol](https://github.com/QubitPi/mieru/blob/master/docs/protocol.md).
...
1. [Server Installation & Configuration](https://github.com/QubitPi/mieru/blob/master/docs/server-install.md)
2. [Client Installation & Configuration](https://github.com/QubitPi/mieru/blob/master/docs/client-install.md)
3. [Client Installation & Configuration - OpenWrt](https://github.com/QubitPi/mieru/blob/master/docs/client-install-openwrt.md)
4. [Maintenance & Troubleshooting](https://github.com/QubitPi/mieru/blob/master/docs/operation.md)
5. [Security Guide](https://github.com/QubitPi/mieru/blob/master/docs/security.md)
